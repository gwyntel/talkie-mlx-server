"""Generation utilities for the MLX Talkie model."""
...
from .chat import Message, format_chat, format_prompt, truncate_at_stop
from .model import TalkieModel
from .tokenizer import IT_SPECIAL_TOKENS, build_tokenizer
...
class Talkie:
    def __init__(self, model_dir: str | Path):
        ...
        self.stop_token_ids = {
            IT_SPECIAL_TOKENS["<|end|>"],
            IT_SPECIAL_TOKENS["<|user|>"],
            IT_SPECIAL_TOKENS["<|system|>"],
            IT_SPECIAL_TOKENS["<|endoftext|>"],
        }
    ...
    def stream(self, prompt: str, config: GenerationConfig | None = None):
        config = config or GenerationConfig()
        emitted = ""
    ...
    def prompt(self, prompt: str, config: GenerationConfig | None = None) -> str:
        return self.generate(format_prompt(prompt), config)
